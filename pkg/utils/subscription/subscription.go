...
import (
	...
	"github.com/onosproject/onos-e2-sm/servicemodels/e2sm_rc/v1/e2sm-rc-ies"
...
// from SubscriptionUtil


func CreateEventTriggerDefinitionUtil() ([]byte, error) {
...
//TODO: Policyfor tx power with change of Nrcgi to cgi

func CreateSubscriptionActionsUtil(policies []PolicyForOcn) (*e2api.Action, error) {
